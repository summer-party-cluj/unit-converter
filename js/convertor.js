...
function CalculateUnit(sourceForm, targetForm){
	...
	if ( !isNaN(sourceValue) || sourceValue == 0){
		...
		sourceForm.unit_input.style.background = "#FFFFFF";
		sourceForm.unit_input.value = sourceValue;
		ConvertFromTo(sourceForm, targetForm);
		} else {
		sourceForm.unit_input.style.background = "#FF0000";
		sourceForm.unit_input.placeholder = "Yor value is invalid"
	}
}
...
function Switch(){
	// switch the input boxes...
	var aux = document.form_A.unit_menu.selectedIndex;

	document.form_A.unit_menu.selectedIndex = document.form_B.unit_menu.selectedIndex;
	document.form_B.unit_menu.selectedIndex = aux;
	document.form_A.unit_input.value = document.form_B.unit_input.value;
